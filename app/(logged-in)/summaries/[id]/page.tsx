  ...
  return (
    <div className="relative isolate min-h-screen bg-[var(--paper)]">
      ...
      <div className="container mx-auto flex flex-col gap-4">
        <div className="summary-page-padding px-4 sm:px-6 lg:px-8 py-6 sm:py-12 lg:py-24">
          <div className="flex flex-col">
            ...
            <div className="relative mt-8 sm:mt-8 lg:mt-16">
             <div className="custom-padding-0 relative p-4 sm:p-6 lg:p-8 bg-[var(--paper-card)] rounded-2xl sm:rounded-3xl border border-[var(--border)] shadow-xl transition-shadow duration-300 hover:shadow-2xl max-w-[550px] lg:max-w-[700px] mx-auto">
