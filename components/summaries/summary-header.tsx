...
const SummaryHeader = ({
  ...
  return (
    <>
      <div className="custom-summary-header flex gap-4 mb-4 justify-between">
        <div className="space-y-5">
          <div className="custom-meta flex flex-wrap items-center gap-3 sm:gap-4">
          ...
          <h1 className="summary-header-title font-display text-2xl lg:text-4xl text-[var(--ink)] lg:tracking-tight">
            {title}
          </h1>
        </div>
      ...
      <h1 className="summary-header-title custom-display-block font-display text-2xl lg:text-4xl text-[var(--ink)] lg:tracking-tight">
        {title}
      </h1>
    </>
  );
